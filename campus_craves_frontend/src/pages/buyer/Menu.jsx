...
const Menu = () => {
  ...
  const fetchProducts = async (categoryId) => {
    try {
      const res = await axios.get(
        `${baseURL}/products/public/products/${storeId}/${categoryId}/`
      );
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(`${baseURL}/products/public/categories/${storeId}/`);
  ...
  const fetchCart=async()=> {
    try {
      const res = await axios.get(`${baseURL}/cart/${storeId}/`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
        },
  ...
  const fetchStore = async () => {
    const res = await axios.get(`${baseURL}/stores/${storeId}/`, {
      headers: {
        Authorization: `Bearer ${accessToken}`,
        "Content-Type": "application/json",
      },
