...
const SellerProfileWithStores = () => {
  ...
  const handleCreateStore = async () => {
    try {
      const response = await axios.post(`${baseURL}/stores/create/`, newStore, {
        headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` },
      });
  ...
  const handleUpdateStore = async () => {
    ...
    try {
      await axios.put(`${baseURL}/stores/${editingStore}/`, editedStore, {
        headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` },
      });
  ...
  const toggleEdit = () => {
    if (isEditing) {
      axios.put(`${baseURL}/users/profile/`, sellerData, {
        headers: {
